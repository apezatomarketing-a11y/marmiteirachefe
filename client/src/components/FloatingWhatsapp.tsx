      ...
      {isVisible && (
        <div className="fixed bottom-6 right-6 z-40 group">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="relative flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-primary to-accent text-white shadow-2xl hover:shadow-2xl transition-all duration-300 group"
