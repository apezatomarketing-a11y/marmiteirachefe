...
export default function Footer() {
  ...
  const privacyContent = `A NutreChefy respeita sua privacidade e está comprometida em proteger seus dados pessoais. Esta Política de Privacidade explica como coletamos, usamos e protegemos suas informações.
...
DIREITOS DO USUÁRIO
Você tem o direito de acessar, corrigir ou solicitar a exclusão de seus dados pessoais. Entre em contato conosco através do email contato@nutrechefy.com.br.

ALTERAÇÕES NA POLÍTICA
Podemos atualizar esta política periodicamente. Notificaremos você sobre mudanças significativas através do site.

CONTATO
Para dúvidas sobre esta política, entre em contato: contato@nutrechefy.com.br`;
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="md:col-span-1">
              <div className="bg-gradient-to-br from-primary to-secondary rounded-lg p-4 mb-4">
                <p className="text-white font-bold text-2xl">NutreChefy</p>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Marmitas saudáveis com sabor de casa. Alimentação equilibrada, prática e feita com cuidado para sua rotina.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/sobre"><a className="text-muted-foreground hover:text-primary transition-colors">Sobre</a></Link></li>
                <li><Link href="/cardapio"><a className="text-muted-foreground hover:text-primary transition-colors">Cardápio</a></Link></li>
                <li><Link href="/buffet"><a className="text-muted-foreground hover:text-primary transition-colors">Buffet</a></Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground text-sm">
                ...
                <li>
                  <a href="mailto:contato@nutrechefy.com.br" className="hover:text-primary transition-colors">
                    contato@nutrechefy.com.br
                  </a>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="https://www.instagram.com/amarmiteirachef/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-sm">Instagram</a></li>
                <li><a href="https://www.facebook.com/nutrechefy" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-sm">Facebook</a></li>
              </ul>
            </div>
          </div>
